...
class DoublePatti extends StatefulWidget {

  @override
  _DoublePattiState createState() => _DoublePattiState();
}

class _DoublePattiState extends State<DoublePatti> {
